...
# 7 int32 (block_dim, aicpu_thread_num, pipeline_strategy,
# enable_l2_swimlane, enable_dump_tensor, enable_pmu, enable_dep_gen) + 1024-byte NUL-terminated output_prefix. Log
...
def _read_config_from_mailbox(buf: memoryview) -> "CallConfig":
    ...
    block_dim, aicpu_tn, pipeline_strategy, swl, dt, pmu, dep_gen, prefix_bytes = _CFG_FMT.unpack_from(
        buf, _OFF_CONFIG
    )
    cfg = CallConfig()
