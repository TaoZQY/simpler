...
Public HBG kernel launch and its registered CANN entry points are not enabled by
these interfaces. The owner connects the control callbacks and event ordering;
