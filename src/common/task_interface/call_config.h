 ...
 * (block_dim, aicpu_thread_num, pipeline_strategy) plus the four parallel diagnostics
...
struct CallConfig {
    ...
    int32_t pipeline_strategy = -1;  // -1 = env/default baseline; 0 = 2S2O control; >=1 = strategy layout
