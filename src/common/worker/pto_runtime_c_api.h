 ...
 * kernels or re-copying the orch SO. `pipeline_strategy` selects the
 * experimental AICPU scheduler/orchestrator layout; `-1` preserves the
 * unset 3S1O baseline, while `0` selects the 2S2O control layout. The AICPU
 * side dispatches via `orch_so_table_[callable_id]` (see
