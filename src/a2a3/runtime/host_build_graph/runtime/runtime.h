...
public:
    ...
    int pipeline_strategy;                    // Compatibility knob for shared platform AICPU affinity gate
    bool pipeline_defer_submit_disabled;      // Compatibility knob for shared host C API
