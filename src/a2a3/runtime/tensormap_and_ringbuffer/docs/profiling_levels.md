...
- Primary orchestrator timing (`orch_start`, `orch_end`, `orch_cost`)
- Secondary orchestrator worker timing (`orch_stage_start`, `orch_stage_end`,
  `orch_stage_cost`)
...
- `Thread %d: orch_start=%llu orch_end=%llu orch_cost=%.3fus` — primary orchestrator after orchestration fully completes
- `Thread %d: orch_stage_start=%llu orch_stage_end=%llu orch_stage=%d orch_stage_cost=%.3fus` — each secondary orchestrator worker after its submit pipeline work completes
...
- `orch_to_sched_=false` (default): `N_sched*2 + 1 + N_stage + 1` (primary
  orch timing + PTO2_total + secondary orch worker timing + sched_timing +
  Scheduler_summary)
- `orch_to_sched_=true` (`PTO2_ORCH_TO_SCHED=1`): orchestrator-stage threads
  may continue into scheduler dispatch depending on executor layout.
...
Thread 3: orch_stage_start=48214752949010 orch_stage_end=48214752951026 orch_stage=1 orch_stage_cost=42.000us
...
```text
Thread 2: orch_start=48236915044001 orch_end=48236915058781 orch_cost=308.000us
Thread 3: orch_stage_start=48236915045003 orch_stage_end=48236915058307 orch_stage=1 orch_stage_cost=277.000us
PTO2 total submitted tasks = 13, already executed 13 tasks
