...
Thread 2: orch_stage_start=48214752949010 orch_stage_end=48214752952573 orch_stage=1 orch_stage_cost=74.220us
```
...
| **orch_stage_start / orch_stage_end** | `AicpuExecutor::run` around `run_submit_pipeline_worker()` | Wall time for each secondary orchestrator worker that participates in the submit pipeline |
