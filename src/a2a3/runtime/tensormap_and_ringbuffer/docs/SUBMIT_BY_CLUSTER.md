...
4. Push task to scheduler's wiring queue (scheduler thread 0 asynchronously wires fanout edges and determines readiness; ready tasks are grouped by shape before batch-pushing to ready queues).
