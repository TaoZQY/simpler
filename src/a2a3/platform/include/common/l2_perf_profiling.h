 ...
 * Orchestrator counter phases (25+): one-shot run-level counters.
 */
enum class AicpuPhaseId : uint32_t {
    ...
    ORCH_PIPELINE_COUNTERS = 25,        // submit-pipeline run-level counters
    ORCH_O1_FOUR_STAGE_COUNTERS = 26,   // front/submitter/tensormap/updater cycles
    ORCH_O1_SUBMIT_COUNTERS_A = 27,     // layout/prepare/descriptor/deferred-meta cycles
    ORCH_O1_SUBMIT_COUNTERS_B = 28,     // enqueue/return/payload/wrapper cycles
    ORCH_O1_PREPARE_COUNTERS = 29,      // prepare sub-step cycles
    ORCH_O1_ACTIVITY_COUNTERS = 30,     // active/detail counts and output volume
};
 ...
 *   ORCH_PIPELINE_COUNTERS: extra1 = compact deferred-submit record count
 *                           extra2 = deferred-submit commit record count
 *   ORCH_O1_*_COUNTERS: extra1/extra2 = run-level O1 diagnostic counters
 *                        keyed by task_id/submit_idx subkind in JSON export
