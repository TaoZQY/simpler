...
/**
 * Maximum AICPU runtime threads.
 * A3 pipeline experiments use up to 6 physical AICPU threads for scheduler
 * and orchestrator roles.
 */
constexpr int PLATFORM_MAX_AICPU_THREADS = 6;
constexpr int PLATFORM_MAX_AICPU_THREADS_JUST_FOR_LAUNCH = PLATFORM_MAX_AICPU_THREADS;
